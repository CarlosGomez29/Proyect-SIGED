      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)] w-[calc(var(--sidebar-width)_+theme(spacing.4))]"
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
        {children}
        <button className="absolute top-3 right-3 group-data-[collapsible=icon]:hidden" onClick={toggleSidebar}>
