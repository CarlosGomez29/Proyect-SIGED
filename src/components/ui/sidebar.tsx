  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-40 hidden h-svh transition-[left,right,width] ease-linear md:flex border-r",
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("relative flex h-14 items-center justify-between border-b p-2", className)}
      {...props}
    >
        {children}
